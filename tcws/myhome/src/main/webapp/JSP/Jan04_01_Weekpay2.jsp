...
let paymentList = [
	{name: document.getElementsByName("username"),  workhour: document.getElementsByName("workhour"), 
		pay: document.getElementsByName("payment")}
];
for(payment of paymentList){
	console.log(payment.name, payment.workhour, payment.pay);
}
}
