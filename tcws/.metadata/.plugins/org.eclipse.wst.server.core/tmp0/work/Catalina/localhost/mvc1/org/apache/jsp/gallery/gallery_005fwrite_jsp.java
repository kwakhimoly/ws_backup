 ...
 * Generated at: 2023-02-03 07:47:12 UTC
...
if(session.getAttribute("user_id")==null||session.getAttribute("user_id").equals("")) {
      ...
      out.write("			<p>select your images</p>\r\n");
      out.write("\r\n");
      ...
      out.write("\"> <input\r\n");
      out.write("									type=\"text\" class=\"form-control\" placeholder=\"이름을 입력하세요\"\r\n");
      out.write("									name=\"user_name\" id=\"user_name\" readonly\r\n");
      out.write("									value=\"");
      out.print(session.getAttribute("user_name"));
      out.write("\">\r\n");
      out.write("							</div>\r\n");
      ...
      out.write("</body>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("//		 url, data : {user_id:\"test\", password:\"1234\"};\r\n");
      out.write("//		 서버로 전송할 파라미터를 읽어와서 data를 만들어준다.\r\n");
      out.write("//		 1.직렬화: 객체를 네트워크나 파일로 그대로 전송하는 기술\r\n");
      out.write("//				serialize 이 함수는 id로 접근한다. 그래서 태그에 id가 있어야 한다 \r\n");
      out.write("//				파일첨부는 안된다. \r\n");
      out.write("//		 2.FormData 객체를 사용\r\n");
      out.write("		\r\n");
      out.write("$(()=>{	\r\n");
      out.write("$(\"#btnSave\").click(()=>{\r\n");
      out.write("		\r\n");
      out.write(" 		$(\"#cmd\").val(\"save2\"); // ajax 통신에 맞춰서 함수 따로 만들기\r\n");
      ...
      out.write("		\r\n");
      out.write("//		const formData = new FormData($(\"#myform\")[0]);\r\n");
      out.write("//		console.log(formData); // 키 값하고 값의 형태로 저장한다. \r\n");
      out.write("		\r\n");
      out.write("//		keys() -> 키 값만 배열 형태로 가져오는 함수\r\n");
      out.write("//		of : 개체 배열로부터 개체를 하나씩 가져오는 연산자\r\n");
      out.write("\r\n");
      ...
      out.write("		dataType:\"JSON\", // 받아올 데이터 타입이 json이다(받아올 때 json으로 받겠다.)\r\n");
      out.write("		type:\"POST\", //파일 전송이라 반드시 POST로(FormData는 파일 전송이 가능)\r\n");
      out.write("		enctype:\"multipart/form-data\", //파일 전송임을 알려주기\r\n");
